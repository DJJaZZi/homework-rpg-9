...
public class WeightCalculator implements ArtifactVisitor {
    ...
    @Override
    public void visit(Scroll scroll) { totalWeight += scroll.getWeight(); }

    @Override
    public void visit(Ring ring) { totalWeight += ring.getWeight(); }

    @Override
    public void visit(Armor armor) { totalWeight += armor.getWeight(); }
}